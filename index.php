...
echo '<section class="ln1-offer-pro"><div><small>BUGUNGI AKSIYA</small><h2>Lavash + kartoshka + ichimlik</h2><p>Birga buyurtma qiling — tez va issiq dastavka.</p></div><a href="#ln1-menu">Aksiyani ko‘rish →</a></div></section>';
...
(function(){
 ...
 if(boxes.length>=2){boxes[1].innerHTML='<h3>Tezkor havolalar</h3><a href="#home">Bosh sahifa</a><a href="#dishes">Taomlar</a><a href="#about">Biz haqimizda</a><a href="#menu">Menyu</a><a href="#review">Fikrlar</a><a href="#order">Buyurtma</a>';}
